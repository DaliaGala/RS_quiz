...
if "questions" not in st.session_state:
    ...
    {"question": "Is a Power BI dashboard built by the Data Engineer for you from the CSV file which Stats & MI provided an internal or external data system?", "options": ["Internal", "External"], "answer": "Internal"},
...
# Main application
st.title('Data In Revenue Scotland: An Interactive Quiz App')
